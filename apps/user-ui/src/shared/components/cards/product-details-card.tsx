...
import { CarrotIcon, Heart, MapPin, X } from "lucide-react";
...
const ProductDetailsCard = ({ data, setOpen }: Props) => {
        ...
        <div className="w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 md:pl-8 mt-6 md:mt-0">
            ...
            <div className="border-b relative pb-3 border-gray-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <Image
                  src={
                    data?.Shop?.avatar ||
                    "https://ik.imagekit.io/devtamhid/products/product-1754905997567_VDz-pJiGx.jpg?updatedAt=1754905999712"
                  }
                  alt="Shop Logo"
                  width={60}
                  height={60}
              ...
              <button
                className="flex cursor-pointer items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 font-semibold rounded-lg text-white"
            ...
            <div className="mt-5 flex items-center gap-5">
              ...
              >
                <CarrotIcon size={18} /> Add to Cart
              </button>
            ...
            <div className="mt-3">
              {data.stock > 0 ? (
                ...
                <span className="texxt-red-600 font-semibold">
                  Out of Stock
                </span>
              )}
            </div>
